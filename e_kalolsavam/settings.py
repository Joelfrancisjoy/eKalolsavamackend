...
ROOT_URLCONF = 'e_kalolsavam.urls'
...
WSGI_APPLICATION = 'e_kalolsavam.wsgi.application'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    # Check if email is allowed for Google signup
    'users.pipeline.check_email_allowed',
    'social_core.pipeline.social_auth.social_user',
    'social_core.pipeline.user.get_username',
    'social_core.pipeline.user.create_user',
    'users.pipeline.assign_default_role',  # Custom pipeline to assign default role
